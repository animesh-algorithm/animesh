...
export function ArrowUpRight({ className }: IconProps) {
  return (
    <svg
      {...iconSize}
      className={["interface-icon", className].filter(Boolean).join(" ")}
      viewBox="0 0 20 20"
      fill="none"
      aria-hidden="true"
    >
...
export function ArrowDown({ className }: IconProps) {
  return (
    <svg {...iconSize} className={className} viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M10 3v14m-5-5 5 5 5-5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ArrowDownRight({ className }: IconProps) {
  return (
    <svg {...iconSize} className={className} viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M5 5l10 10m0-7v7H8" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ArrowRight({ className }: IconProps) {
  return (
    <svg {...iconSize} className={className} viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M3 10h14m-5-5 5 5-5 5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ArrowUp({ className }: IconProps) {
  return (
    <svg {...iconSize} className={className} viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M10 17V3m-5 5 5-5 5 5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function GitHub({ className }: IconProps) {
  return (
    <svg {...iconSize} className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
export function Spark({ className }: IconProps) {
  return (
    <svg width="32" height="32" className={className} viewBox="0 0 32 32" fill="none" aria-hidden="true">
...
export function ChatBubble({ className }: IconProps) {
  return (
    <svg width="24" height="24" className={className} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
