...
export default function ServicesPage() { const booking = getBookingDestination(); return <main id="main-content" className="v2-services-page"><ServicesSection /><div className="site-shell v2-page-tail"><h2>Start with the problem.</h2><p>I can define the right scope after seeing the workflow and what you need to ship.</p><div className="hero-actions"><a className="button" href={booking.href}>{booking.configured ? "Book a call" : "Request a call"}</a><Link className="text-link" href="/contact">Send a brief</Link></div></div></main>; }
