...
export const engagements = [
  validateContent(engagementSchema, {
    ...
    promise: "Get your page live.",
    audience: "For founders with a clear direction and a launch to make.",
    included: [
      "Landing page or marketing site",
      "Built from Figma or an existing direction",
  ...
  validateContent(engagementSchema, {
    ...
    promise: "Build the product you need.",
    audience: "For founders who need an MVP scoped, built and shipped.",
    included: [
      "Product scoping & technical decisions",
      "Web, SaaS, AI or mobile product",
      "Frontend + backend",
      "Authentication & permissions",
      "Database & APIs",
      "Payments & third-party integrations",
      "AI/LLM features where useful",
  ...
  validateContent(engagementSchema, {
    ...
    priceSuffix: "/mo",
    promise: "Keep your product moving.",
    audience: "For founders who need an owner for ongoing product work.",
    included: [
      "Feature development",
      "Product iteration",
      ...
      "Weekly shipping/progress updates",
...
export const faqs = [
  validateContent(faqSchema, {
    ...
    answer:
      "Ship a Page is for an established direction that needs to go live. Build a Product covers a scoped MVP or product. Monthly Retainer is for ongoing ownership of an existing product.",
  }),
  validateContent(faqSchema, {
  ...
  validateContent(faqSchema, {
    ...
    answer:
      "Choose a time in the calendar on this page or on Contact. If the calendar is unavailable, request a call by email or send a brief.",
  }),
] as const;
